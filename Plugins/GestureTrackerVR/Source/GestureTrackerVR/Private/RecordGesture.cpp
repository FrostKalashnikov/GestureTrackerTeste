...
void RecordGesture::Reset(const FVector &inStartLocation, const FRotator &inRotator, float inResolution)
{
    RecordGesture::Reset(inStartLocation, inRotator, inResolution, MAX_int32);
}

void RecordGesture::Reset(const FVector &inStartLocation, const FRotator &inRotator, float inResolution, int inMaxSize)
{
    Gesture::Reset(inStartLocation, inRotator, inResolution);
